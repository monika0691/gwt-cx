...
public class BlueToolBarAppearance_BlueToolBarDefaultResources_en_InlineClientBundleGenerator implements com.sencha.gxt.theme.blue.client.toolbar.BlueToolBarAppearance.BlueToolBarDefaultResources {
  private static BlueToolBarAppearance_BlueToolBarDefaultResources_en_InlineClientBundleGenerator _instance0 = new BlueToolBarAppearance_BlueToolBarDefaultResources_en_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.blue.client.toolbar.BlueToolBarAppearance.BlueToolBarDefaultStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GAVOEIYGVB-com-sencha-gxt-theme-blue-client-toolbar-BlueToolBarAppearance-BlueToolBarDefaultStyle-toolBar {\n  border-style : " + ("solid")  + ";\n  border-width : " + ("0"+ " " +"0"+ " " +"1px"+ " " +"0")  + ";\n  display : " + ("block")  + ";\n  background : " + ("repeat-x"+ " " +"top"+ " " +"right")  + ";\n  position : " + ("relative")  + ";\n  right : " + ("0")  + ";\n  top : " + ("0")  + ";\n  zoom : " + ("1")  + ";\n  overflow : " + ("hidden")  + ";\n  width : " + ("auto")  + ";\n  height : ") + (("auto")  + ";\n  border : " + ("none")  + ";\n}\n/* @external x-toolbar-mark; */\n.x-toolbar-mark {\n  border-width : " + ("0"+ " " +"0"+ " " +"1px"+ " " +"0")  + ";\n  border-bottom : " + ("1px"+ " " +"solid"+ " " +"#99b9e9")  + ";\n  height : " + ((BlueToolBarAppearance_BlueToolBarDefaultResources_en_InlineClientBundleGenerator.this.background()).getHeight() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueToolBarAppearance_BlueToolBarDefaultResources_en_InlineClientBundleGenerator.this.background()).getSafeUri().asString() + "\") -" + (BlueToolBarAppearance_BlueToolBarDefaultResources_en_InlineClientBundleGenerator.this.background()).getLeft() + "px -" + (BlueToolBarAppearance_BlueToolBarDefaultResources_en_InlineClientBundleGenerator.this.background()).getTop() + "px  repeat-x")  + ";\n  background-color : " + ("#d0def0")  + ";\n  height : " + ("auto")  + ";\n}\n")) : ((".GAVOEIYGVB-com-sencha-gxt-theme-blue-client-toolbar-BlueToolBarAppearance-BlueToolBarDefaultStyle-toolBar {\n  border-style : " + ("solid")  + ";\n  border-width : " + ("0"+ " " +"0"+ " " +"1px"+ " " +"0")  + ";\n  display : " + ("block")  + ";\n  background : " + ("repeat-x"+ " " +"top"+ " " +"left")  + ";\n  position : " + ("relative")  + ";\n  left : " + ("0")  + ";\n  top : " + ("0")  + ";\n  zoom : " + ("1")  + ";\n  overflow : " + ("hidden")  + ";\n  width : " + ("auto")  + ";\n  height : ") + (("auto")  + ";\n  border : " + ("none")  + ";\n}\n/* @external x-toolbar-mark; */\n.x-toolbar-mark {\n  border-width : " + ("0"+ " " +"0"+ " " +"1px"+ " " +"0")  + ";\n  border-bottom : " + ("1px"+ " " +"solid"+ " " +"#99b9e9")  + ";\n  height : " + ((BlueToolBarAppearance_BlueToolBarDefaultResources_en_InlineClientBundleGenerator.this.background()).getHeight() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueToolBarAppearance_BlueToolBarDefaultResources_en_InlineClientBundleGenerator.this.background()).getSafeUri().asString() + "\") -" + (BlueToolBarAppearance_BlueToolBarDefaultResources_en_InlineClientBundleGenerator.this.background()).getLeft() + "px -" + (BlueToolBarAppearance_BlueToolBarDefaultResources_en_InlineClientBundleGenerator.this.background()).getTop() + "px  repeat-x")  + ";\n  background-color : " + ("#d0def0")  + ";\n  height : " + ("auto")  + ";\n}\n"));
      }
