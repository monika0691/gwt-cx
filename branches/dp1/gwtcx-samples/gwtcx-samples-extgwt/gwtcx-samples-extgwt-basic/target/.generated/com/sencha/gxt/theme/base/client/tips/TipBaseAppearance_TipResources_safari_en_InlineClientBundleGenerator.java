...
public class TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator implements com.sencha.gxt.theme.base.client.tips.TipBaseAppearance.TipResources {
  private static TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator _instance0 = new TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.base.client.tips.TipBaseAppearance.TipStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GAVOEIYCGB-com-sencha-gxt-theme-base-client-tips-TipBaseAppearance-TipStyle-tools {\n  float : " + ("left")  + ";\n}\n.GAVOEIYAGB-com-sencha-gxt-theme-base-client-tips-TipBaseAppearance-TipStyle-heading {\n  color : " + ("#444")  + ";\n  font : " + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";\n  display : " + ("none")  + ";\n}\n.GAVOEIYBGB-com-sencha-gxt-theme-base-client-tips-TipBaseAppearance-TipStyle-text {\n  color : " + ("#444")  + ";\n  font : " + ("11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";\n  white-space : " + ("nowrap")  + ";\n  padding-right : " + ("2px")  + ";\n  padding-left : " + ("2px")  + ";\n}\n.GAVOEIYNFB-com-sencha-gxt-theme-base-client-tips-TipBaseAppearance-TipStyle-anchorBottom {\n  height : " + ((TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getHeight() + "px")  + ";\n  width : ") + (((TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getSafeUri().asString() + "\") -" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getLeft() + "px -" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getTop() + "px  no-repeat")  + ";\n  position : " + ("absolute")  + ";\n}\n.GAVOEIYPFB-com-sencha-gxt-theme-base-client-tips-TipBaseAppearance-TipStyle-anchorRight {\n  height : " + ((TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getHeight() + "px")  + ";\n  width : " + ((TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getSafeUri().asString() + "\") -" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getLeft() + "px -" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getTop() + "px  no-repeat")  + ";\n  position : " + ("absolute")  + ";\n}\n.GAVOEIYOFB-com-sencha-gxt-theme-base-client-tips-TipBaseAppearance-TipStyle-anchorLeft {\n  height : " + ((TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getHeight() + "px")  + ";\n  width : " + ((TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getWidth() + "px") ) + (";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getSafeUri().asString() + "\") -" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getLeft() + "px -" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getTop() + "px  no-repeat")  + ";\n  position : " + ("absolute")  + ";\n}\n")) : ((".GAVOEIYCGB-com-sencha-gxt-theme-base-client-tips-TipBaseAppearance-TipStyle-tools {\n  float : " + ("right")  + ";\n}\n.GAVOEIYAGB-com-sencha-gxt-theme-base-client-tips-TipBaseAppearance-TipStyle-heading {\n  color : " + ("#444")  + ";\n  font : " + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";\n  display : " + ("none")  + ";\n}\n.GAVOEIYBGB-com-sencha-gxt-theme-base-client-tips-TipBaseAppearance-TipStyle-text {\n  color : " + ("#444")  + ";\n  font : " + ("11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";\n  white-space : " + ("nowrap")  + ";\n  padding-left : " + ("2px")  + ";\n  padding-right : " + ("2px")  + ";\n}\n.GAVOEIYNFB-com-sencha-gxt-theme-base-client-tips-TipBaseAppearance-TipStyle-anchorBottom {\n  height : " + ((TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getHeight() + "px")  + ";\n  width : ") + (((TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getSafeUri().asString() + "\") -" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getLeft() + "px -" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getTop() + "px  no-repeat")  + ";\n  position : " + ("absolute")  + ";\n}\n.GAVOEIYPFB-com-sencha-gxt-theme-base-client-tips-TipBaseAppearance-TipStyle-anchorRight {\n  height : " + ((TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getHeight() + "px")  + ";\n  width : " + ((TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getSafeUri().asString() + "\") -" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getLeft() + "px -" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getTop() + "px  no-repeat")  + ";\n  position : " + ("absolute")  + ";\n}\n.GAVOEIYOFB-com-sencha-gxt-theme-base-client-tips-TipBaseAppearance-TipStyle-anchorLeft {\n  height : " + ((TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getHeight() + "px")  + ";\n  width : " + ((TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getWidth() + "px") ) + (";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getSafeUri().asString() + "\") -" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getLeft() + "px -" + (TipBaseAppearance_TipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getTop() + "px  no-repeat")  + ";\n  position : " + ("absolute")  + ";\n}\n"));
      }
