...
public class TabletGinjectorImpl implements com.gwtcx.sample.basic.client.gin.TabletGinjector {
  ...
  /**
   * Binding for com.gwtcx.sample.basic.client.view.tablet.MainPageTabletView declared at:
   *   com.gwtplatform.mvp.client.gin.AbstractPresenterModule.bindPresenter(AbstractPresenterModule.java:124)
   */
  private void memberInject_Key$type$com$gwtcx$sample$basic$client$view$tablet$MainPageTabletView$_annotation$$none$$(com.gwtcx.sample.basic.client.view.tablet.MainPageTabletView injectee) {
    
  }
  
  private com.gwtcx.sample.basic.client.view.tablet.MainPageTabletView com$gwtcx$sample$basic$client$view$tablet$MainPageTabletView_MainPageTabletView_methodInjection() {
    return new com.gwtcx.sample.basic.client.view.tablet.MainPageTabletView();
  }
  
  private com.gwtcx.sample.basic.client.view.tablet.MainPageTabletView create_Key$type$com$gwtcx$sample$basic$client$view$tablet$MainPageTabletView$_annotation$$none$$() {
    com.gwtcx.sample.basic.client.view.tablet.MainPageTabletView result = com$gwtcx$sample$basic$client$view$tablet$MainPageTabletView_MainPageTabletView_methodInjection();
    memberInject_Key$type$com$gwtcx$sample$basic$client$view$tablet$MainPageTabletView$_annotation$$none$$(result);
    return result;
  }
  
  private com.gwtcx.sample.basic.client.view.tablet.MainPageTabletView singleton_Key$type$com$gwtcx$sample$basic$client$view$tablet$MainPageTabletView$_annotation$$none$$ = null;
   ...
   *   com.gwtplatform.mvp.client.gin.AbstractPresenterModule.bindPresenter(AbstractPresenterModule.java:124)
   */
  private com.gwtcx.sample.basic.client.view.tablet.MainPageTabletView get_Key$type$com$gwtcx$sample$basic$client$view$tablet$MainPageTabletView$_annotation$$none$$() {
    if (singleton_Key$type$com$gwtcx$sample$basic$client$view$tablet$MainPageTabletView$_annotation$$none$$ == null) {
      singleton_Key$type$com$gwtcx$sample$basic$client$view$tablet$MainPageTabletView$_annotation$$none$$ = create_Key$type$com$gwtcx$sample$basic$client$view$tablet$MainPageTabletView$_annotation$$none$$();
    }
    return singleton_Key$type$com$gwtcx$sample$basic$client$view$tablet$MainPageTabletView$_annotation$$none$$;
  }
  ...
  private com.gwtcx.sample.basic.client.presenter.MainPagePresenter.MyView create_Key$type$com$gwtcx$sample$basic$client$presenter$MainPagePresenter$MyView$_annotation$$none$$() {
    return get_Key$type$com$gwtcx$sample$basic$client$view$tablet$MainPageTabletView$_annotation$$none$$();
  }
