...
public class ReportServlet extends HttpServlet {
  ...
  @GuardedBy("this") private Context initialContext;
  @GuardedBy("this") private Context localContext;
  @GuardedBy("this") private DataSource dataSource;
  @GuardedBy("this") private Connection connection;
  ...
  private void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      synchronized(this) {
        ...
        localContext = (Context) initialContext.lookup("java:comp/env");
        dataSource = (DataSource) localContext.lookup(dsName);
