...
defaultPlotOptions.funnel = merge(defaultPlotOptions.pie, {
    marker: null, // funnel options are specified in the base options
    width: '90%',
    neckWidth: '30%',
    height: '100%',
    neckHeight: '25%',
...
defaultPlotOptions.pyramid = merge(defaultPlotOptions.funnel, {
    marker: null, // pyramid options are specified in the base options
    width: '0%',
    neckWidth: '100%',
    height: '100%',
    neckHeight: '0%',
...
Series.prototype = {
  ...
  getAttribs: function() {
    ...
    log.debug("series.type: ", series.type);
...
// funnel
var FunnelSeries = extendClass(seriesTypes.pie, {
  type: 'funnel',
  ...
  drawPoints: function(point) {
    ...
    log.debug("drawPoints() - end");
  },

  drawDataLabels: function() {

  log.debug("drawDataLabels() - start");
...
// pyramid
var PyramidSeries = extendClass(seriesTypes.funnel, {
  type: 'pyramid'

});

seriesTypes.pyramid = PyramidSeries;
// end pyramid
