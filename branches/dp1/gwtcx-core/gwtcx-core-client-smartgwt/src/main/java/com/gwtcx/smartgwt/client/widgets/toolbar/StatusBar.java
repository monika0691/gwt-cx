...
public class StatusBar extends HLayout {
  ...
  public StatusBar() {
    ...
    resultSetFirstButton.setSrc(SmartGwtEntryPoint.getThemedResource(RESULTSET_FIRST_BUTTON));
    ...
    resultSetPreviousButton.setSrc(SmartGwtEntryPoint.getThemedResource(RESULTSET_PREVIOUS_BUTTON));
    ...
    resultSetNextButton.setSrc(SmartGwtEntryPoint.getThemedResource(RESULTSET_NEXT_BUTTON));
