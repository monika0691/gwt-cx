...
package com.gwtcx.smartgwt.client.entrypoint;

import com.google.gwt.core.client.EntryPoint;
import com.google.gwt.core.client.GWT;
import com.gwtcx.client.util.I18nUtil;
import com.gwtcx.smartgwt.client.theme.AquaClientBundle;
...
public class SmartGwtEntryPoint implements EntryPoint {
  ...
  public void onModuleLoad() {
    ...
    if (! SmartGwtEntryPoint.initialised) {

      I18nUtil.init();

      setTheme(AQUA_THEME);

      SmartGwtEntryPoint.initialised = true;
    }
  }
  ...
  public void setTheme(String theme) {
    if (theme.equalsIgnoreCase(AQUA_THEME)) {
      ...
      SmartGwtEntryPoint.theme = theme;
    }
  }
