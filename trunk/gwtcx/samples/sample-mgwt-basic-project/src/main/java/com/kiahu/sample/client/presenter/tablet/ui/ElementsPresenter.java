...
public class ElementsPresenter extends
    Presenter<ElementsPresenter.MyView, ElementsPresenter.MyProxy> {
  ...
  //
  @ProxyCodeSplit
  @NameToken(NameTokens.elements)
  public interface MyProxy extends Proxy<ElementsPresenter>, Place {
  }
  ...
  @Inject
  public ElementsPresenter(final EventBus eventBus, final MyView view, final MyProxy proxy) {
    super(eventBus, view, proxy);

    Log.debug("ElementsPresenter()");
  }
