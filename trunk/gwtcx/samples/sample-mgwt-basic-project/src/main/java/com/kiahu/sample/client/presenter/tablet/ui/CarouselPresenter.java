...
public class CarouselPresenter extends
    Presenter<CarouselPresenter.MyView, CarouselPresenter.MyProxy> {
  ...
  public interface MyProxy extends Proxy<CarouselPresenter>, Place {
  }
  ...
  @Inject
  public CarouselPresenter(final EventBus eventBus, final MyView view, final MyProxy proxy) {
    super(eventBus, view, proxy);

    Log.debug("CarouselPresenter()");
  }
