...
public class ProgressBarPresenter extends
    Presenter<ProgressBarPresenter.MyView, ProgressBarPresenter.MyProxy> {
  ...
  //
  @ProxyCodeSplit
  @NameToken(NameTokens.progressBar)
  public interface MyProxy extends Proxy<ProgressBarPresenter>, Place {
  }
  ...
  @Inject
  public ProgressBarPresenter(final EventBus eventBus, final MyView view, final MyProxy proxy) {
    super(eventBus, view, proxy);

    Log.debug("ProgressBarPresenter()");
  }
