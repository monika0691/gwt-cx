...
public class FormsPresenter extends
    Presenter<FormsPresenter.MyView, FormsPresenter.MyProxy> {
  ...
  public interface MyProxy extends Proxy<FormsPresenter>, Place {
  }
  ...
  @Inject
  public FormsPresenter(final EventBus eventBus, final MyView view, final MyProxy proxy) {
    super(eventBus, view, proxy);

    Log.debug("FormsPresenter()");
  }
