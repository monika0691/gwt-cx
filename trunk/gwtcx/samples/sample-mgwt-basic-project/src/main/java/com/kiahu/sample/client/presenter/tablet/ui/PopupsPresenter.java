...
public class PopupsPresenter extends
    Presenter<PopupsPresenter.MyView, PopupsPresenter.MyProxy> {
  ...
  //
  @ProxyCodeSplit
  @NameToken(NameTokens.popups)
  public interface MyProxy extends Proxy<PopupsPresenter>, Place {
  }
  ...
  @Inject
  public PopupsPresenter(final EventBus eventBus, final MyView view, final MyProxy proxy) {
    super(eventBus, view, proxy);

    Log.debug("PopupsPresenter()");
  }
