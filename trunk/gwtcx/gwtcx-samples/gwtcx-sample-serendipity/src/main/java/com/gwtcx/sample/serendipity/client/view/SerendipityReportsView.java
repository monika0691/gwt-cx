...
import com.gwtcx.client.smartgwt.view.ReportsView;
...
public class SerendipityReportsView extends ReportsView<ReportsUiHandlers> implements
    SerendipityReportsPresenter.MyView {

  @Inject
  public SerendipityReportsView(ToolBar toolBar, ReportsContextAreaListGrid listGrid,
      StatusBar statusBar) {
