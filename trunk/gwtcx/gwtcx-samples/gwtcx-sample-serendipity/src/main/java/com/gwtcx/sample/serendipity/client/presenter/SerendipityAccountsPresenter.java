...
import com.gwtcx.client.presenter.AccountsPresenter;
...
public class SerendipityAccountsPresenter extends
    AccountsPresenter<SerendipityAccountsPresenter.MyView, SerendipityAccountsPresenter.MyProxy> implements
  AccountsUiHandlers {
  ...
  public interface MyProxy extends Proxy<SerendipityAccountsPresenter>, Place {
  }
  ...
  @Inject
  public SerendipityAccountsPresenter(EventBus eventBus, MyView view, MyProxy proxy,
  ...
  protected void onReveal() {
    ...
    SerendipityMainPagePresenter.getNavigationPaneHeader().setContextAreaHeaderLabelContents(GwtCx.getConstant().accountsMenuItemName());
    SerendipityMainPagePresenter.getNavigationPane().selectRecord(NameTokens.accounts);
  }
