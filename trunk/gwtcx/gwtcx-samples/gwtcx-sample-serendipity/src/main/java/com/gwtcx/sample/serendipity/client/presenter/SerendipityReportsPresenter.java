...
import com.gwtcx.client.presenter.ReportsPresenter;
...
public class SerendipityReportsPresenter extends
    ReportsPresenter<SerendipityReportsPresenter.MyView, SerendipityReportsPresenter.MyProxy> implements
    ReportsUiHandlers {
  ...
  public interface MyProxy extends Proxy<SerendipityReportsPresenter>, Place {
  }
  ...
  @Inject
  public SerendipityReportsPresenter(EventBus eventBus, MyView view, MyProxy proxy,
  ...
  protected void onReveal() {
    ...
    SerendipityMainPagePresenter.getNavigationPaneHeader().setContextAreaHeaderLabelContents(GwtCx.getConstant().reportsMenuItemName());
    SerendipityMainPagePresenter.getNavigationPane().selectRecord(NameTokens.reports);
  }
