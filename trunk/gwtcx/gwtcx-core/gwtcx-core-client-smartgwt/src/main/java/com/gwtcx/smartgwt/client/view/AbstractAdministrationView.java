...
import com.gwtcx.smartgwt.client.widgets.grid.SettingsContextAreaListGrid;
...
public abstract class AbstractAdministrationView<C extends UiHandlers> extends ViewWithUiHandlers<C> {
  ...
  @Inject
  public AbstractAdministrationView(SettingsContextAreaListGrid listGrid) {
    super();
