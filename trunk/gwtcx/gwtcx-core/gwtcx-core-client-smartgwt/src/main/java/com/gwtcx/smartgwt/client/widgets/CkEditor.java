...
public class CkEditor extends Canvas {
  ...
  protected native void loadCKEditor() /*-{
    ...
    if (! this.@com.gwtcx.smartgwt.clientwidgets.CkEditor::initialised) {
      var editorId = this.@com.gwtcx.smartgwt.client.widgets.CkEditor::getID()() + "_ta";
      $wnd.CKEDITOR.replace(editorId);
      this.@com.gwtcx.smartgwt.client.widgets.CkEditor::initialised = true;
    }
  }-*/;
