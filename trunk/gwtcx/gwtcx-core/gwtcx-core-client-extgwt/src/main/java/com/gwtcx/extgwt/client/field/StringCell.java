...
public class StringCell extends TriggerFieldCell<String> {
  ...
  public void expand(Context context, final XElement parent, String value, ValueUpdater<String> valueUpdater) {
    ...
    Info.display("Clicked", "You clicked the look up button.");
...
//http://www.sencha.com/forum/showthread.php?170557-Trying-the-Appearance-Design-Pattern-what-am-I-doing-wrong
