...
public class AquaCssConstants {
  ...
  protected static final String urlPrefix = "gwtcx/skins/" + ExtGwtEntryPoint.getTheme() + "/images/";
  ...
  /**
   * URL to the Masthead Logo.
   *
   * @return  the image url
   */
  public static String getMastheadLogo() {
    return "url(" + moduleBaseUrl + urlPrefix + "logo.png" + ")";
  }
