...
import com.gwtcx.extgwt.client.desktop.view.AbstractFormDesktopView;
...
public class ContactInformationFormDesktopView extends AbstractFormDesktopView<ContactInformationUiHandlers> {
  // implements ContactInformationPresenter.MyView {
  ...
  @Inject
  public ContactInformationFormDesktopView(final EventBus eventBus) {
    super(eventBus);
