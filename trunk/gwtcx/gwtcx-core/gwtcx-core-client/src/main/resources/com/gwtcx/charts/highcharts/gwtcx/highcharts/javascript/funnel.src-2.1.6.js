...
log.debug("Highcharts 2.1.6 - Funnel Chart extension");
...
var FunnelSeries = Highcharts.extendClass(seriesTypes.pie, {
  ...
  log.debug("FunnelSeries - translate()");

    // get positions - either an integer or a percentage string must be given
    function getLength(length, relativeTo) {

      log.debug("FunnelSeries - getLength()");
  ...
  drawPoints: function(point) {
    ...
    log.debug("FunnelSeries - drawPoints()");
  ...
  log.debug("FunnelSeries - drawDataLabels()");
