...
public class TinyMceEditor extends Canvas {
  ...
  protected native void configureTinyMceEditor() /*-{
    if (! this.@com.gwtcx.client.smartgwt.widgets.TinyMceEditor::initialised) {
  ...
  protected native void loadTinyMceEditor() /*-{
    if (! this.@com.gwtcx.client.smartgwt.widgets.TinyMceEditor::initialised) {
      var editorId = this.@com.gwtcx.client.smartgwt.widgets.TinyMceEditor::getID()() + "_ta";
      $wnd.tinyMCE.execCommand('mceAddControl', true, editorId);
      this.@com.gwtcx.client.smartgwt.widgets.TinyMceEditor::initialised = true;
    }
  }-*/;
