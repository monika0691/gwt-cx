...
package com.gwtcx.client.smartgwt.data;
...
public class ResourceCentreNpsDataSource extends NavigationPaneSectionDataSource {
  ...
  protected static final String DATA_SOURCE = "ResourceCentreNps";
  // private static final String URL_PREFIX = "datasource/data/ResourceCentreNps";
  protected static final String URL_PREFIX = GWT.getModuleName() + "/gwtcx/smartgwt/" + "datasource/data/ResourceCentreNps";
