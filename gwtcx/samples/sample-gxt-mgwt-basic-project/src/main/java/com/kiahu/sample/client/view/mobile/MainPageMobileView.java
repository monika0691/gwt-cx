...
package com.kiahu.sample.client.view.mobile;
...
public class MainPageMobileView extends AbstractMainPageDesktopView<MainPageUiHandlers> implements
  ...
  @Inject
  public MainPageMobileView(final EventBus eventBus, final Masthead masthead, final ApplicationMenu applicationMenu) {
