...
public class ButtonBarPresenter extends
    Presenter<ButtonBarPresenter.MyView, ButtonBarPresenter.MyProxy> {
  ...
  //
  @ProxyCodeSplit
  @NameToken(NameTokens.buttonBar)
  public interface MyProxy extends Proxy<ButtonBarPresenter>, Place {
  }
  ...
  @Inject
  public ButtonBarPresenter(final EventBus eventBus, final MyView view, final MyProxy proxy) {
    super(eventBus, view, proxy);

    Log.debug("ButtonBarPresenter()");
  }
