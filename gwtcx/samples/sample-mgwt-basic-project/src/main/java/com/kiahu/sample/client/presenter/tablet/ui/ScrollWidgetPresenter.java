...
public class ScrollWidgetPresenter extends
    Presenter<ScrollWidgetPresenter.MyView, ScrollWidgetPresenter.MyProxy> {
  ...
  //
  @ProxyCodeSplit
  @NameToken(NameTokens.scrollWidget)
  public interface MyProxy extends Proxy<ScrollWidgetPresenter>, Place {
  }
  ...
  @Inject
  public ScrollWidgetPresenter(final EventBus eventBus, final MyView view, final MyProxy proxy) {
    super(eventBus, view, proxy);

    Log.debug("ScrollWidgetPresenter()");
  }
