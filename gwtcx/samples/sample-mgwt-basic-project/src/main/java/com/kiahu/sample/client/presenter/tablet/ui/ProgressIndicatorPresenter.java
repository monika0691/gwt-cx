...
public class ProgressIndicatorPresenter extends
    Presenter<ProgressIndicatorPresenter.MyView, ProgressIndicatorPresenter.MyProxy> {
  ...
  //
  @ProxyCodeSplit
  @NameToken(NameTokens.progressIndicator)
  public interface MyProxy extends Proxy<ProgressIndicatorPresenter>, Place {
  }
  ...
  @Inject
  public ProgressIndicatorPresenter(final EventBus eventBus, final MyView view, final MyProxy proxy) {
    super(eventBus, view, proxy);

    Log.debug("ProgressIndicatorPresenter()");
  }
