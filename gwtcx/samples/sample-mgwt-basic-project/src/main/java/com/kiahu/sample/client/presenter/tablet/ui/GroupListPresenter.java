...
public class GroupListPresenter extends
    Presenter<GroupListPresenter.MyView, GroupListPresenter.MyProxy> {
  ...
  //
  @ProxyCodeSplit
  @NameToken(NameTokens.groupList)
  public interface MyProxy extends Proxy<GroupListPresenter>, Place {
  }
  ...
  @Inject
  public GroupListPresenter(final EventBus eventBus, final MyView view, final MyProxy proxy) {
    super(eventBus, view, proxy);

    Log.debug("GroupListPresenter()");
  }
