...
public class TabBarPresenter extends
    Presenter<TabBarPresenter.MyView, TabBarPresenter.MyProxy> {
  ...
  //
  @ProxyCodeSplit
  @NameToken(NameTokens.tabBar)
  public interface MyProxy extends Proxy<TabBarPresenter>, Place {
  }
  ...
  @Inject
  public TabBarPresenter(final EventBus eventBus, final MyView view, final MyProxy proxy) {
    super(eventBus, view, proxy);

    Log.debug("TabBarPresenter()");
  }
