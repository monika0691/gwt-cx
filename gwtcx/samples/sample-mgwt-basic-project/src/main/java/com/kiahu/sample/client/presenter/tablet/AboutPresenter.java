...
public class AboutPresenter extends
  ...
  public interface MyProxy extends Proxy<AboutPresenter>, Place {
  }
  ...
  @Inject
  public AboutPresenter(final EventBus eventBus, final MyView view, final MyProxy proxy) {
    super(eventBus, view, proxy);

    Log.debug("AboutPresenter()");
  }
