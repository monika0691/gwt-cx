...
public class DissolvePresenter extends
    Presenter<DissolvePresenter.MyView, DissolvePresenter.MyProxy>  implements
      AnimationUiHandlers {
  ...
  //
  @ProxyCodeSplit
  @NameToken(NameTokens.dissolve)
  public interface MyProxy extends Proxy<DissolvePresenter>, Place {
  }
  ...
  @Inject
  public DissolvePresenter(final EventBus eventBus, final MyView view, final MyProxy proxy,
      final PlaceManager placeManager) {
	super(eventBus, view, proxy);

    Log.debug("DissolvePresenter()");
