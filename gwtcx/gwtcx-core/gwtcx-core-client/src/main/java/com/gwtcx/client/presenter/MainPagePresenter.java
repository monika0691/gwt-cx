...
public abstract class MainPagePresenter<V extends View, Proxy_ extends Proxy<?>> extends Presenter<V, Proxy_> implements MainPageUiHandlers {
  ...
  @Inject
  public MainPagePresenter(EventBus eventBus, V view, Proxy_ proxy, PlaceManager placeManager) {
