...
import com.gwtcx.client.presenter.PagingPresenter;
import com.gwtcx.client.smartgwt.widgets.grid.ContextAreaListGrid;
...
public abstract class PagingView<C extends UiHandlers> extends ViewWithUiHandlers<C> {
  ...
  public PagingView(ToolBar toolBar, ContextAreaListGrid listGrid, StatusBar statusBar) {
    ...
    this.numberOfElements = PagingPresenter.DEFAULT_MAX_RESULTS;
