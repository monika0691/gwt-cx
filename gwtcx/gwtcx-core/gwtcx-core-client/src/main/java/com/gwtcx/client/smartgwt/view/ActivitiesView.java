...
public abstract class ActivitiesView<C extends UiHandlers> extends PagingView<C> {
  ...
  protected void initToolBar() {
    ...
    getToolBar().addButton(GwtCxEntryPoint.getThemedResource(ToolBar.NEW_ACTIVITY_BUTTON), I18nUtil.getConstant().newButton(),
