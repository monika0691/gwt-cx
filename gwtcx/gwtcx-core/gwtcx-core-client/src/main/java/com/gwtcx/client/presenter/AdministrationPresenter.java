...
public abstract class AdministrationPresenter<V extends View, Proxy_ extends Proxy<?>> extends
  ...
  @Inject
  public AdministrationPresenter(EventBus eventBus, V view, Proxy_ proxy,
