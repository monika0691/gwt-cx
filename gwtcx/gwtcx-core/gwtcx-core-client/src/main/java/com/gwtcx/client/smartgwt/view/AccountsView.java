...
import com.gwtcx.client.smartgwt.widgets.grid.AccountsRecord;
...
public abstract class AccountsView<C extends UiHandlers> extends PagingView<C> {
  ...
  protected void initToolBar() {
    ...
    getToolBar().addButton(GwtCxEntryPoint.getThemedResource(ToolBar.NEW_ACCOUNT_BUTTON), I18nUtil.getConstant().newButton(),
    ...
    getToolBar().addButton(GwtCxEntryPoint.getThemedResource(ToolBar.MAIL_MERGE_BUTTON),
        I18nUtil.getConstant().mailMergeButtonTooltip(), null);
    getToolBar().addButton(GwtCxEntryPoint.getThemedResource(ToolBar.REPORTS_BUTTON),
    ...
    getToolBar().addButton(GwtCxEntryPoint.getThemedResource(ToolBar.WORKFLOW_BUTTON), I18nUtil.getConstant().workflowButton(),
