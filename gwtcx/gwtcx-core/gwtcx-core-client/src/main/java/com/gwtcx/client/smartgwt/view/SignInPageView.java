...
import com.gwtcx.client.util.FieldVerifier;
...
public abstract class SignInPageView<C extends UiHandlers> extends ViewWithUiHandlers<C> {
      ...
      public void onClick(ClickEvent event) {
        ...
        if (FieldVerifier.isValidUserName(getUserName().getText()) &&
          ...
          if (getUiHandlers() != null) {
            ((SignInPageUiHandlers) getUiHandlers()).onOkButtonClicked();
          }
        }
        else {
          event.cancel();
