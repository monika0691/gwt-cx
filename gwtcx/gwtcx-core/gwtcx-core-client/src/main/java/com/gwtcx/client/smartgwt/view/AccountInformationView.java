...
import com.gwtcx.client.smartgwt.view.handlers.AccountInformationUiHandlers;
...
public class AccountInformationView extends ViewWithUiHandlers<AccountInformationUiHandlers>
  ...
  protected void initToolBar() {
    ...
    toolBar.addButton(GwtCxEntryPoint.getThemedResource(ToolBar.SAVE_BUTTON),
    ...
    toolBar.addButton(GwtCxEntryPoint.getThemedResource(ToolBar.SAVE_AND_CLOSE_BUTTON),
    ...
    toolBar.addButton(GwtCxEntryPoint.getThemedResource(ToolBar.PRINT_PREVIEW_BUTTON),
    ...
    toolBar.addButton(GwtCxEntryPoint.getThemedResource(ToolBar.EMAIL_BUTTON),
    ...
    toolBar.addButton(GwtCxEntryPoint.getThemedResource(ToolBar.ATTACH_BUTTON),
    ...
    toolBar.addButton(ToolBar.REPORTS_BUTTON,
        I18nUtil.getConstant().reportsButtonTooltip(), new ClickHandler() {
      public void onClick(ClickEvent event) {
        if (getUiHandlers() != null) {
    ...
    */
    ...
    toolBar.addButton(GwtCxEntryPoint.getThemedResource(ToolBar.HELP_BUTTON),
