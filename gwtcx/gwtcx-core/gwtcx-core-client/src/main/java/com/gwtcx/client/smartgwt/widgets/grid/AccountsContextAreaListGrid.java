...
public class AccountsContextAreaListGrid extends ContextAreaListGrid {
  ...
  public static final int ACCOUNT_NAME_COLUMN_WIDTH = 140;
  public static final int MAIN_PHONE_COLUMN_WIDTH = 90;
  public static final int LOCATION_COLUMN_WIDTH = 220; // 80
  public static final int PRIMARY_CONTACT_COLUMN_WIDTH = 100;
  public static final int EMAIL_PRIMARY_CONTACT_COLUMN_WIDTH = 120;
