...
import com.gwtcx.client.smartgwt.data.SettingsCaDataSource;
...
public class SettingsContextAreaListGrid extends ListGrid {
  ...
  public SettingsContextAreaListGrid() {
    ...
    featureIcon1Field.setImageURLPrefix(GwtCxEntryPoint.getThemedResource(LARGE_ICON_URL_PREFIX));
    ...
    featureIcon2Field.setImageURLPrefix(GwtCxEntryPoint.getThemedResource(LARGE_ICON_URL_PREFIX));
