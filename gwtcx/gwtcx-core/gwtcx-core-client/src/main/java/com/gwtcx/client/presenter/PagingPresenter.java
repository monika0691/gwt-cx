 ...
 * SalesPresenter
 */
public abstract class PagingPresenter<V extends View, Proxy_ extends Proxy<?>> extends Presenter<V, Proxy_> {
  ...
  @Inject
  public PagingPresenter(EventBus eventBus, V view, Proxy_ proxy, DispatchAsync dispatcher, PlaceManager placeManager) {
