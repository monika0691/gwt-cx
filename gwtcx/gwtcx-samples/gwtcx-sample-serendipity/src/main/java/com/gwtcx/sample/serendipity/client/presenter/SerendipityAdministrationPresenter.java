...
import com.gwtcx.client.presenter.AdministrationPresenter;
...
public class SerendipityAdministrationPresenter extends
    AdministrationPresenter<SerendipityAdministrationPresenter.MyView, SerendipityAdministrationPresenter.MyProxy> implements
  ...
  public interface MyProxy extends Proxy<SerendipityAdministrationPresenter>, Place {
  }
  ...
  @Inject
  public SerendipityAdministrationPresenter(EventBus eventBus, MyView view, MyProxy proxy,
  ...
  protected void onReveal() {
    ...
    SerendipityMainPagePresenter.getNavigationPaneHeader().setContextAreaHeaderLabelContents(GwtCx.getConstant().administrationMenuItemName());
