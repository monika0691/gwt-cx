...
import com.gwtcx.client.smartgwt.view.ImportsView;
...
public class SerendipityImportsView extends ImportsView<ImportsUiHandlers> implements
    SerendipityImportsPresenter.MyView {

  @Inject
  public SerendipityImportsView(ToolBar toolBar, ImportsContextAreaListGrid listGrid,
      StatusBar statusBar) {
