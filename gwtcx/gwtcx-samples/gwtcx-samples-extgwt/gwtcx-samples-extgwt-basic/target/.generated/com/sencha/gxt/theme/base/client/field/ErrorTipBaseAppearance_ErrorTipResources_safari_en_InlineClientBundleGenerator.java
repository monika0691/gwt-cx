...
public class ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator implements com.sencha.gxt.theme.base.client.field.ErrorTipBaseAppearance.ErrorTipResources {
  private static ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator _instance0 = new ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.base.client.field.ErrorTipBaseAppearance.ErrorTipStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GAVOEIYGR-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-tools {\n  float : " + ("left")  + ";\n}\n.GAVOEIYER-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-heading {\n  color : " + ("#444")  + ";\n  font : " + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";\n  display : " + ("none")  + ";\n}\n.GAVOEIYFR-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-text {\n  color : " + ("#444")  + ";\n  font : " + ("11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";\n  white-space : " + ("nowrap")  + ";\n  padding-right : " + ("2px")  + ";\n  padding-left : " + ("2px")  + ";\n}\n.GAVOEIYBR-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-anchorBottom {\n  height : " + ((ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getHeight() + "px")  + ";\n  width : ") + (((ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getSafeUri().asString() + "\") -" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getLeft() + "px -" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getTop() + "px  no-repeat")  + ";\n  position : " + ("absolute")  + ";\n}\n.GAVOEIYDR-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-anchorRight {\n  height : " + ((ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getHeight() + "px")  + ";\n  width : " + ((ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getSafeUri().asString() + "\") -" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getLeft() + "px -" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getTop() + "px  no-repeat")  + ";\n  position : " + ("absolute")  + ";\n}\n.GAVOEIYCR-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-anchorLeft {\n  height : " + ((ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getHeight() + "px")  + ";\n  width : " + ((ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getWidth() + "px") ) + (";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getSafeUri().asString() + "\") -" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getLeft() + "px -" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getTop() + "px  no-repeat")  + ";\n  position : " + ("absolute")  + ";\n}\n.GAVOEIYER-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-heading, .GAVOEIYFR-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-text {\n  font : " + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";\n  color : " + ("#444")  + ";\n}\n")) : ((".GAVOEIYGR-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-tools {\n  float : " + ("right")  + ";\n}\n.GAVOEIYER-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-heading {\n  color : " + ("#444")  + ";\n  font : " + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";\n  display : " + ("none")  + ";\n}\n.GAVOEIYFR-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-text {\n  color : " + ("#444")  + ";\n  font : " + ("11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";\n  white-space : " + ("nowrap")  + ";\n  padding-left : " + ("2px")  + ";\n  padding-right : " + ("2px")  + ";\n}\n.GAVOEIYBR-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-anchorBottom {\n  height : " + ((ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getHeight() + "px")  + ";\n  width : ") + (((ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getSafeUri().asString() + "\") -" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getLeft() + "px -" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorBottom()).getTop() + "px  no-repeat")  + ";\n  position : " + ("absolute")  + ";\n}\n.GAVOEIYDR-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-anchorRight {\n  height : " + ((ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getHeight() + "px")  + ";\n  width : " + ((ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getSafeUri().asString() + "\") -" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getLeft() + "px -" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorRight()).getTop() + "px  no-repeat")  + ";\n  position : " + ("absolute")  + ";\n}\n.GAVOEIYCR-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-anchorLeft {\n  height : " + ((ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getHeight() + "px")  + ";\n  width : " + ((ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getWidth() + "px") ) + (";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getSafeUri().asString() + "\") -" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getLeft() + "px -" + (ErrorTipBaseAppearance_ErrorTipResources_safari_en_InlineClientBundleGenerator.this.anchorLeft()).getTop() + "px  no-repeat")  + ";\n  position : " + ("absolute")  + ";\n}\n.GAVOEIYER-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-heading, .GAVOEIYFR-com-sencha-gxt-theme-base-client-field-ErrorTipBaseAppearance-ErrorTipStyle-text {\n  font : " + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";\n  color : " + ("#444")  + ";\n}\n"));
      }
