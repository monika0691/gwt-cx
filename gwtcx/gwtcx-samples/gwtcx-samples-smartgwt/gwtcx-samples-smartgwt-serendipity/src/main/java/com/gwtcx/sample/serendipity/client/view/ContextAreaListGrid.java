...
public class ContextAreaListGrid extends ListGrid {
  ...
  public ContextAreaListGrid(DataSource dataSource) {
    super();
    ...
    featureIcon1Field.setImageURLPrefix(SmartGwtCx.getResource(URL_PREFIX));
    ...
    featureIcon2Field.setImageURLPrefix(SmartGwtCx.getResource(URL_PREFIX));
