...
public class ApplicationMenu extends HLayout {
  ...
  public static final String APPLICATION_MENU_STYLE_NAME = "gwtcx-ApplicationMenu";

  public static final int APPLICATION_MENU_HEIGHT = 27;
  public static final int DEFAULT_SHADOW_DEPTH = 10;
  ...
  public ApplicationMenu() {
    ...
    this.setStyleName(APPLICATION_MENU_STYLE_NAME);
  ...
  private String getIcon(String applicationName) {
    ...
    return SmartGwtEntryPoint.getThemedResource(icon);
  }
}
