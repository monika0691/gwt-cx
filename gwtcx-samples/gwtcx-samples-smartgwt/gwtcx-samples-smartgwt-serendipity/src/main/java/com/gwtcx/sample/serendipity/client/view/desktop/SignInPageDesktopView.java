...
public class SignInPageDesktopView extends AbstractSignInPageView {
  ...
  public SignInPageDesktopView() {
    super();

    Log.debug("SignInPageDesktopView()");
...
public class SerendipitySignInPageMobileView extends AbstractSignInPageView<SignInPageUiHandlers>
  ...
  private static String html = "<div>\n"
    ...
    + "  </tr>\n"
    + "  <tr>\n"
    + "    <td colspan=\"2\">Contact your Serendipity mobile administrator.</td>\n"
    + "  </tr>\n"
    + "</table>\n"
    + "</div>\n";

  public SerendipitySignInPageMobileView() {
    super();
