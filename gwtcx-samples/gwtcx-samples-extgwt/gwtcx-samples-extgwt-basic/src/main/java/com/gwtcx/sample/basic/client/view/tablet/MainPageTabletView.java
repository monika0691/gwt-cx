...
package com.gwtcx.sample.basic.client.view.tablet;
...
public class MainPageTabletView extends ViewWithUiHandlers<MainPageUiHandlers> implements MainPagePresenter.MyView {

  private static String html = "<h1>Basic Web Application Starter Project</h1>\n"
      + "<table align=\"center\">\n"
      + "  <tr>\n"
      + "    <td colspan=\"2\" style=\"font-weight:bold;\">Please enter your (Tablet) name:</td>\n"
      + "  </tr>\n"
      + "  <tr>\n"
