...
public class SeparatorToolItemBaseAppearance_SeparatorToolItemBaseResources_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.base.client.toolbar.SeparatorToolItemBaseAppearance.SeparatorToolItemBaseResources {
  private static SeparatorToolItemBaseAppearance_SeparatorToolItemBaseResources_default_InlineClientBundleGenerator _instance0 = new SeparatorToolItemBaseAppearance_SeparatorToolItemBaseResources_default_InlineClientBundleGenerator();
  ...
  private void cssInitializer() {
    css = new com.sencha.gxt.theme.base.client.toolbar.SeparatorToolItemBaseAppearance.SeparatorToolItemStyle() {
      ...
      public String getText() {
        return (".GAVOEIYEGB-com-sencha-gxt-theme-base-client-toolbar-SeparatorToolItemBaseAppearance-SeparatorToolItemStyle-separator {\n  width : " + ((SeparatorToolItemBaseAppearance_SeparatorToolItemBaseResources_default_InlineClientBundleGenerator.this.background()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (SeparatorToolItemBaseAppearance_SeparatorToolItemBaseResources_default_InlineClientBundleGenerator.this.background()).getSafeUri().asString() + "\") -" + (SeparatorToolItemBaseAppearance_SeparatorToolItemBaseResources_default_InlineClientBundleGenerator.this.background()).getLeft() + "px -" + (SeparatorToolItemBaseAppearance_SeparatorToolItemBaseResources_default_InlineClientBundleGenerator.this.background()).getTop() + "px  repeat-y")  + ";\n  background-position : " + ("center"+ " " +"center")  + ";\n  background-repeat : " + ("no-repeat")  + ";\n  border : " + ("0"+ " " +"none")  + ";\n  cursor : " + ("default")  + ";\n  display : " + ("block")  + ";\n  font-size : " + ("1px")  + ";\n  height : " + ("16px")  + ";\n  padding : ") + (("0"+ " " +"3px")  + ";\n  overflow : " + ("hidden")  + ";\n}\n");
      }
