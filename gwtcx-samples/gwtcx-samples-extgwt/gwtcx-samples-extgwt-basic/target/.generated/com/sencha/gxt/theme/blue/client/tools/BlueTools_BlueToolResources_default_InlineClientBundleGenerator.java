...
public class BlueTools_BlueToolResources_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.blue.client.tools.BlueTools.BlueToolResources {
  private static BlueTools_BlueToolResources_default_InlineClientBundleGenerator _instance0 = new BlueTools_BlueToolResources_default_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.widget.core.client.button.Tools.ToolStyle() {
      ...
      public String getText() {
        return (".GAVOEIYJXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-close {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.closeIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.closeIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.closeIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.closeIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.closeIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYKXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-closeOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.closeOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.closeOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.closeOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.closeOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.closeOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYLXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-collapse {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.collapseIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.collapseIcon()).getWidth() + "px")  + ";\n  overflow : ") + (("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.collapseIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.collapseIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.collapseIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYMXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-collapseOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.collapseOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.collapseOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.collapseOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.collapseOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.collapseOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYNXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleDown {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleDownIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleDownIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleDownIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleDownIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleDownIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYOXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleDownOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleDownOverIcon()).getHeight() + "px") ) + (";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleDownOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleDownOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleDownOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleDownOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYPXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleLeft {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleLeftIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleLeftIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleLeftIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleLeftIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleLeftIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYAYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleLeftOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleLeftOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleLeftOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : ") + (("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleLeftOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleLeftOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleLeftOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYBYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleRight {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleRightIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleRightIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleRightIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleRightIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleRightIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYCYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleRightOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleRightOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleRightOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleRightOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleRightOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleRightOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYDYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleUp {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleUpIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleUpIcon()).getWidth() + "px") ) + (";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleUpIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleUpIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleUpIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYEYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleUpOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleUpOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleUpOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleUpOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleUpOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.doubleUpOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYFYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-down {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.downIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.downIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.downIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.downIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.downIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYGYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-downOver {\n  height : ") + (((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.downOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.downOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.downOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.downOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.downOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYHYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-expand {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.expandIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.expandIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.expandIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.expandIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.expandIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYIYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-expandOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.expandOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.expandOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden") ) + (";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.expandOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.expandOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.expandOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYJYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-gear {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.gearIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.gearIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.gearIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.gearIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.gearIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYKYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-gearOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.gearOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.gearOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.gearOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.gearOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.gearOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYLYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-left {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.leftIcon()).getHeight() + "px")  + ";\n  width : ") + (((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.leftIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.leftIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.leftIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.leftIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYMYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-leftOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.leftOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.leftOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.leftOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.leftOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.leftOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYNYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-maximize {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.maximizeIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.maximizeIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.maximizeIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.maximizeIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.maximizeIcon()).getTop() + "px  no-repeat") ) + (";\n}\n.GAVOEIYOYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-maximizeOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.maximizeOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.maximizeOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.maximizeOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.maximizeOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.maximizeOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYPYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-minimize {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minimizeIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minimizeIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minimizeIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minimizeIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minimizeIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYA-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-minimizeOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minimizeOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minimizeOverIcon()).getWidth() + "px")  + ";\n  overflow : ") + (("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minimizeOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minimizeOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minimizeOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYB-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-minus {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minusIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minusIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minusIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minusIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minusIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYC-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-minusOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minusOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minusOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minusOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minusOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.minusOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYD-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-pin {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.pinIcon()).getHeight() + "px") ) + (";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.pinIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.pinIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.pinIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.pinIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYE-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-pinOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.pinOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.pinOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.pinOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.pinOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.pinOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYF0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-unpin {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.unpinIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.unpinIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : ") + (("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.unpinIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.unpinIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.unpinIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYG0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-unpinOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.unpinOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.unpinOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.unpinOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.unpinOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.unpinOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYF-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-plus {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.plusIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.plusIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.plusIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.plusIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.plusIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYG-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-plusOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.plusOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.plusOverIcon()).getWidth() + "px") ) + (";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.plusOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.plusOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.plusOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYH-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-print {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.printIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.printIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.printIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.printIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.printIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYI-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-printOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.printOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.printOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.printOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.printOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.printOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYJ-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-question {\n  height : ") + (((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYK-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-questionOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYL-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-refresh {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden") ) + (";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYM-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-refreshOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.questionOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYN-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-restore {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.restoreIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.restoreIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.restoreIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.restoreIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.restoreIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYO-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-restoreOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.restoreOverIcon()).getHeight() + "px")  + ";\n  width : ") + (((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.restoreOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.restoreOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.restoreOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.restoreOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYP-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-right {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.rightIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.rightIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.rightIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.rightIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.rightIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYA0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-rightOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.rightOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.rightOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.rightOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.rightOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.rightOverIcon()).getTop() + "px  no-repeat") ) + (";\n}\n.GAVOEIYB0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-save {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.saveIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.saveIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.saveIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.saveIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.saveIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYC0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-saveOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.saveOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.saveOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.saveOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.saveOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.saveOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYD0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-search {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.searchIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.searchIcon()).getWidth() + "px")  + ";\n  overflow : ") + (("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.searchIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.searchIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.searchIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYE0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-searchOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.searchOverIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.searchOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.searchOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.searchOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.searchOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYH0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-up {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.upIcon()).getHeight() + "px")  + ";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.upIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.upIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.upIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.upIcon()).getTop() + "px  no-repeat")  + ";\n}\n.GAVOEIYI0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-upOver {\n  height : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.upOverIcon()).getHeight() + "px") ) + (";\n  width : " + ((BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.upOverIcon()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.upOverIcon()).getSafeUri().asString() + "\") -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.upOverIcon()).getLeft() + "px -" + (BlueTools_BlueToolResources_default_InlineClientBundleGenerator.this.upOverIcon()).getTop() + "px  no-repeat")  + ";\n}\n");
      }
      public java.lang.String close(){
        return "GAVOEIYJXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-close";
      }
      public java.lang.String closeOver(){
        return "GAVOEIYKXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-closeOver";
      }
      public java.lang.String collapse(){
        return "GAVOEIYLXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-collapse";
      }
      public java.lang.String collapseOver(){
        return "GAVOEIYMXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-collapseOver";
      }
      public java.lang.String doubleDown(){
        return "GAVOEIYNXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleDown";
      }
      public java.lang.String doubleDownOver(){
        return "GAVOEIYOXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleDownOver";
      }
      public java.lang.String doubleLeft(){
        return "GAVOEIYPXB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleLeft";
      }
      public java.lang.String doubleLeftOver(){
        return "GAVOEIYAYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleLeftOver";
      }
      public java.lang.String doubleRight(){
        return "GAVOEIYBYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleRight";
      }
      public java.lang.String doubleRightOver(){
        return "GAVOEIYCYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleRightOver";
      }
      public java.lang.String doubleUp(){
        return "GAVOEIYDYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleUp";
      }
      public java.lang.String doubleUpOver(){
        return "GAVOEIYEYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-doubleUpOver";
      }
      public java.lang.String down(){
        return "GAVOEIYFYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-down";
      }
      public java.lang.String downOver(){
        return "GAVOEIYGYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-downOver";
      }
      public java.lang.String expand(){
        return "GAVOEIYHYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-expand";
      }
      public java.lang.String expandOver(){
        return "GAVOEIYIYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-expandOver";
      }
      public java.lang.String gear(){
        return "GAVOEIYJYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-gear";
      }
      public java.lang.String gearOver(){
        return "GAVOEIYKYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-gearOver";
      }
      public java.lang.String left(){
        return "GAVOEIYLYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-left";
      }
      public java.lang.String leftOver(){
        return "GAVOEIYMYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-leftOver";
      }
      public java.lang.String maximize(){
        return "GAVOEIYNYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-maximize";
      }
      public java.lang.String maximizeOver(){
        return "GAVOEIYOYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-maximizeOver";
      }
      public java.lang.String minimize(){
        return "GAVOEIYPYB-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-minimize";
      }
      public java.lang.String minimizeOver(){
        return "GAVOEIYA-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-minimizeOver";
      }
      public java.lang.String minus(){
        return "GAVOEIYB-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-minus";
      }
      public java.lang.String minusOver(){
        return "GAVOEIYC-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-minusOver";
      }
      public java.lang.String pin(){
        return "GAVOEIYD-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-pin";
      }
      public java.lang.String pinOver(){
        return "GAVOEIYE-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-pinOver";
      }
      public java.lang.String plus(){
        return "GAVOEIYF-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-plus";
      }
      public java.lang.String plusOver(){
        return "GAVOEIYG-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-plusOver";
      }
      public java.lang.String print(){
        return "GAVOEIYH-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-print";
      }
      public java.lang.String printOver(){
        return "GAVOEIYI-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-printOver";
      }
      public java.lang.String question(){
        return "GAVOEIYJ-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-question";
      }
      public java.lang.String questionOver(){
        return "GAVOEIYK-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-questionOver";
      }
      public java.lang.String refresh(){
        return "GAVOEIYL-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-refresh";
      }
      public java.lang.String refreshOver(){
        return "GAVOEIYM-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-refreshOver";
      }
      public java.lang.String restore(){
        return "GAVOEIYN-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-restore";
      }
      public java.lang.String restoreOver(){
        return "GAVOEIYO-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-restoreOver";
      }
      public java.lang.String right(){
        return "GAVOEIYP-B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-right";
      }
      public java.lang.String rightOver(){
        return "GAVOEIYA0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-rightOver";
      }
      public java.lang.String save(){
        return "GAVOEIYB0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-save";
      }
      public java.lang.String saveOver(){
        return "GAVOEIYC0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-saveOver";
      }
      public java.lang.String search(){
        return "GAVOEIYD0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-search";
      }
      public java.lang.String searchOver(){
        return "GAVOEIYE0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-searchOver";
      }
      public java.lang.String unpin(){
        return "GAVOEIYF0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-unpin";
      }
      public java.lang.String unpinOver(){
        return "GAVOEIYG0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-unpinOver";
      }
      public java.lang.String up(){
        return "GAVOEIYH0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-up";
      }
      public java.lang.String upOver(){
        return "GAVOEIYI0B-com-sencha-gxt-widget-core-client-button-Tools-ToolStyle-upOver";
      }
    }
    ;
  }
  ...
  private static final java.lang.String externalImage = "data:image/png;base64,";
  private static final java.lang.String externalImage0 = "data:image/png;base64,";
  private static final java.lang.String externalImage1 = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA8AAAAPCAYAAAA71pVKAAAAhElEQVR42mNw+A+BhQvuEo1hehhgGs8/+U00hhnAANNICoAZANccWH/4/7Nv/wni939xaIYZgM+/r35SYDMIk6354Wc8zr747A9eZyOHOIpmkEYQxhdNMHmcmvHhKy/+kedskNy1V2h+BpmGbDo+J998gyXAQJEPkiCEURIJRWmbklwFAEIT+MGl7BOCAAAAAElFTkSuQmCC";
  private static final java.lang.String externalImage2 = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA8AAAAPCAYAAAA71pVKAAAAhElEQVR42mNw+A+BhQvuEo1hehhgGs8/+U00hhnAANNICoAZANdsFLrp/7Nv/wni939xaIYZgM+/r35SYDMIk6354Wc8zr747A9eZyOHOIpmkEYQxhdNMHmcmvHhKy/+kedskNy1V2h+BpmGbDo+J998gyXAQJEPkiCEURIJRWmbklwFALbt9ONkvf4gAAAAAElFTkSuQmCC";
  private static final java.lang.String externalImage3 = "data:image/png;base64,";
  private static final java.lang.String externalImage4 = "data:image/png;base64,";
  private static final java.lang.String externalImage5 = "data:image/png;base64,";
  private static final java.lang.String externalImage6 = "data:image/png;base64,";
  private static final java.lang.String externalImage7 = "data:image/png;base64,";
  private static final java.lang.String externalImage8 = "data:image/png;base64,";
  private static final java.lang.String externalImage9 = "data:image/png;base64,";
  private static final java.lang.String externalImage10 = "data:image/png;base64,";
  ...
  private static final java.lang.String externalImage12 = "data:image/png;base64,";
  private static final java.lang.String externalImage13 = "data:image/png;base64,";
  private static final java.lang.String externalImage14 = "data:image/png;base64,";
  ...
  private static final java.lang.String externalImage20 = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA8AAAAPCAYAAAA71pVKAAAAXUlEQVR42mNggILCBXf/E4sZkAFI4PyT30RjuAEwjaQAuAEwze///icaY2gGATXnCQQxVpupohkfIEozthAmWvPFZ38wMNGayXY22QFGUSK5+YYwRkkkFKVtSnIVAEBhw/MR/4yEAAAAAElFTkSuQmCC";
  private static final java.lang.String externalImage21 = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA8AAAAPCAYAAAA71pVKAAAAeUlEQVR42mNggIKZu1/8JxYzIAOQACkAbgCpGlEMgGl+/5d4jKH51U/iMYbmZ9+IxxiaH34mHmNoPv/kN9EYQ/PFZ3/AeP6mxzgxTA2G5isv/oGxmvMEnBimBkPztVcQjM9mmBoMzTffEI+xJhJiNKIkEorSNiW5CgCVhgM0FAqNnwAAAABJRU5ErkJggg==";
  private static final java.lang.String externalImage22 = "data:image/png;base64,";
  private static final java.lang.String externalImage23 = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA8AAAAPCAYAAAA71pVKAAAAgklEQVR42mNggIKZu1/8JxYzIAOQACkAbgCpGlEMgGl+/5d4jKH51U/iMYbmZ9+IxxiaH36G4HOPfuDEMDUYms8/+Q3GhQvu/g9o2ICBQeIwNRiaLz77A8aHr3/CiWFqMDRfefGPaIyh+dor4jGG5ptviMdYEwkxGlESCUVpm5JcBQDmLg0dn/VALwAAAABJRU5ErkJggg==";
  private static final java.lang.String externalImage24 = "data:image/png;base64,";
  private static final java.lang.String externalImage25 = "data:image/png;base64,";
  ...
  private static final java.lang.String externalImage27 = "data:image/png;base64,";
  private static final java.lang.String externalImage28 = "data:image/png;base64,";
  private static final java.lang.String externalImage29 = "data:image/png;base64,";
  private static final java.lang.String externalImage30 = "data:image/png;base64,";
  private static final java.lang.String externalImage31 = "data:image/png;base64,";
  private static final java.lang.String externalImage32 = "data:image/png;base64,";
  private static final java.lang.String externalImage33 = "data:image/png;base64,";
  private static final java.lang.String externalImage34 = "data:image/png;base64,";
  private static final java.lang.String externalImage35 = "data:image/png;base64,";
  private static final java.lang.String externalImage36 = "data:image/png;base64,";
  private static final java.lang.String externalImage37 = "data:image/png;base64,";
  private static final java.lang.String externalImage38 = "data:image/png;base64,";
