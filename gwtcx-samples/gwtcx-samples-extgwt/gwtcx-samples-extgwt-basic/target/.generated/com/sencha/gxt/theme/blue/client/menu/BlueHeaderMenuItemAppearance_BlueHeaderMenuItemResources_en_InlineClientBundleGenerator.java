...
public class BlueHeaderMenuItemAppearance_BlueHeaderMenuItemResources_en_InlineClientBundleGenerator implements com.sencha.gxt.theme.blue.client.menu.BlueHeaderMenuItemAppearance.BlueHeaderMenuItemResources {
  private static BlueHeaderMenuItemAppearance_BlueHeaderMenuItemResources_en_InlineClientBundleGenerator _instance0 = new BlueHeaderMenuItemAppearance_BlueHeaderMenuItemResources_en_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.blue.client.menu.BlueItemAppearance.BlueItemStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GAVOEIYLLB-com-sencha-gxt-theme-blue-client-menu-BlueItemAppearance-BlueItemStyle-active {\n  border-style : " + ("solid")  + ";\n  border-width : " + ("1px")  + ";\n  padding : " + ("0")  + " !important;\n  height : " + ((BlueHeaderMenuItemAppearance_BlueHeaderMenuItemResources_en_InlineClientBundleGenerator.this.itemOver()).getHeight() + "px")  + ";\n  width : " + ((BlueHeaderMenuItemAppearance_BlueHeaderMenuItemResources_en_InlineClientBundleGenerator.this.itemOver()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueHeaderMenuItemAppearance_BlueHeaderMenuItemResources_en_InlineClientBundleGenerator.this.itemOver()).getSafeUri().asString() + "\") -" + (BlueHeaderMenuItemAppearance_BlueHeaderMenuItemResources_en_InlineClientBundleGenerator.this.itemOver()).getLeft() + "px -" + (BlueHeaderMenuItemAppearance_BlueHeaderMenuItemResources_en_InlineClientBundleGenerator.this.itemOver()).getTop() + "px  no-repeat")  + ";\n  width : " + ("auto")  + ";\n  height : " + ("auto")  + ";\n  background-color : " + ("#ebf3fd")  + ";\n  background-repeat : ") + (("repeat-x")  + ";\n  background-position : " + ("right"+ " " +"bottom")  + ";\n  border : " + ("1px"+ " " +"solid"+ " " +"#aaccf6")  + ";\n  padding : " + ("0")  + ";\n}\n/* @external x-menu-item; */\n.GAVOEIYLLB-com-sencha-gxt-theme-blue-client-menu-BlueItemAppearance-BlueItemStyle-active a.x-menu-item {\n  color : " + ("#233d6d")  + ";\n}\n")) : ((".GAVOEIYLLB-com-sencha-gxt-theme-blue-client-menu-BlueItemAppearance-BlueItemStyle-active {\n  border-style : " + ("solid")  + ";\n  border-width : " + ("1px")  + ";\n  padding : " + ("0")  + " !important;\n  height : " + ((BlueHeaderMenuItemAppearance_BlueHeaderMenuItemResources_en_InlineClientBundleGenerator.this.itemOver()).getHeight() + "px")  + ";\n  width : " + ((BlueHeaderMenuItemAppearance_BlueHeaderMenuItemResources_en_InlineClientBundleGenerator.this.itemOver()).getWidth() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (BlueHeaderMenuItemAppearance_BlueHeaderMenuItemResources_en_InlineClientBundleGenerator.this.itemOver()).getSafeUri().asString() + "\") -" + (BlueHeaderMenuItemAppearance_BlueHeaderMenuItemResources_en_InlineClientBundleGenerator.this.itemOver()).getLeft() + "px -" + (BlueHeaderMenuItemAppearance_BlueHeaderMenuItemResources_en_InlineClientBundleGenerator.this.itemOver()).getTop() + "px  no-repeat")  + ";\n  width : " + ("auto")  + ";\n  height : " + ("auto")  + ";\n  background-color : " + ("#ebf3fd")  + ";\n  background-repeat : ") + (("repeat-x")  + ";\n  background-position : " + ("left"+ " " +"bottom")  + ";\n  border : " + ("1px"+ " " +"solid"+ " " +"#aaccf6")  + ";\n  padding : " + ("0")  + ";\n}\n/* @external x-menu-item; */\n.GAVOEIYLLB-com-sencha-gxt-theme-blue-client-menu-BlueItemAppearance-BlueItemStyle-active a.x-menu-item {\n  color : " + ("#233d6d")  + ";\n}\n"));
      }
