...
public class CommonResources_Bundle_safari_en_InlineClientBundleGenerator implements com.google.gwt.resources.client.CommonResources.Bundle {
  private static CommonResources_Bundle_safari_en_InlineClientBundleGenerator _instance0 = new CommonResources_Bundle_safari_en_InlineClientBundleGenerator();
  private void inlineBlockStyleInitializer() {
    inlineBlockStyle = new com.google.gwt.resources.client.CommonResources.InlineBlockStyle() {
      ...
      public String getText() {
        return (".GAVOEIYBB-com-google-gwt-resources-client-CommonResources-InlineBlockStyle-inlineBlock {\n  position : " + ("relative")  + ";\n  display : " + ("inline-block")  + ";\n}\n");
      }
