...
public class MobileGinjectorImpl implements com.gwtcx.sample.basic.client.gin.MobileGinjector {
  ...
  /**
   * Binding for com.gwtcx.sample.basic.client.view.mobile.MainPageMobileView declared at:
   *   com.gwtplatform.mvp.client.gin.AbstractPresenterModule.bindPresenter(AbstractPresenterModule.java:124)
   */
  private void memberInject_Key$type$com$gwtcx$sample$basic$client$view$mobile$MainPageMobileView$_annotation$$none$$(com.gwtcx.sample.basic.client.view.mobile.MainPageMobileView injectee) {
    
  }
  
  private com.gwtcx.sample.basic.client.view.mobile.MainPageMobileView com$gwtcx$sample$basic$client$view$mobile$MainPageMobileView_MainPageMobileView_methodInjection() {
    return new com.gwtcx.sample.basic.client.view.mobile.MainPageMobileView();
  }
  
  private com.gwtcx.sample.basic.client.view.mobile.MainPageMobileView create_Key$type$com$gwtcx$sample$basic$client$view$mobile$MainPageMobileView$_annotation$$none$$() {
    com.gwtcx.sample.basic.client.view.mobile.MainPageMobileView result = com$gwtcx$sample$basic$client$view$mobile$MainPageMobileView_MainPageMobileView_methodInjection();
    memberInject_Key$type$com$gwtcx$sample$basic$client$view$mobile$MainPageMobileView$_annotation$$none$$(result);
    return result;
  }
  
  private com.gwtcx.sample.basic.client.view.mobile.MainPageMobileView singleton_Key$type$com$gwtcx$sample$basic$client$view$mobile$MainPageMobileView$_annotation$$none$$ = null;
   ...
   *   com.gwtplatform.mvp.client.gin.AbstractPresenterModule.bindPresenter(AbstractPresenterModule.java:124)
   */
  private com.gwtcx.sample.basic.client.view.mobile.MainPageMobileView get_Key$type$com$gwtcx$sample$basic$client$view$mobile$MainPageMobileView$_annotation$$none$$() {
    if (singleton_Key$type$com$gwtcx$sample$basic$client$view$mobile$MainPageMobileView$_annotation$$none$$ == null) {
      singleton_Key$type$com$gwtcx$sample$basic$client$view$mobile$MainPageMobileView$_annotation$$none$$ = create_Key$type$com$gwtcx$sample$basic$client$view$mobile$MainPageMobileView$_annotation$$none$$();
    }
    return singleton_Key$type$com$gwtcx$sample$basic$client$view$mobile$MainPageMobileView$_annotation$$none$$;
  }
  ...
  private com.gwtcx.sample.basic.client.presenter.MainPagePresenter.MyView create_Key$type$com$gwtcx$sample$basic$client$presenter$MainPagePresenter$MyView$_annotation$$none$$() {
    return get_Key$type$com$gwtcx$sample$basic$client$view$mobile$MainPageMobileView$_annotation$$none$$();
  }
