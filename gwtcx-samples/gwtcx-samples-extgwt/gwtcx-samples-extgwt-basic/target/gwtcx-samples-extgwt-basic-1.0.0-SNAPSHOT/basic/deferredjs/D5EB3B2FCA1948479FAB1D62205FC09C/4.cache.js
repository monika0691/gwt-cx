...
_.getClass$ = function getClass_227(){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_227;
...
function $ensureInjected(this$static){
  ...
  if (!($location_0[stackIndex] = 'ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator.java:' + '12' , this$static).injected) {
    ($location_0[stackIndex] = 'ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator.java:' + '13' , this$static).injected = true;
    $location_0[stackIndex] = 'ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator.java:' + '14' , inject(($location_0[stackIndex] = 'ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator.java:' + '23' , $clinit_LocaleInfo() , 'buttonsDiv {\n  float : right;\n  margin-top : 5px;\n}\n'));
    $stackDepth_0 = stackIndex - 1;
    return true;
  }
  $stackDepth_0 = stackIndex - 1;
...
function ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator$1_0(){
}

function ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator$1(){
}

_ = ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator$1_0.prototype = ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator$1.prototype = new Object_0;
_.getClass$ = function getClass_235(){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_235;
  returnTemp = ($location_0[stackIndex] = 'ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator.java:' + '9' , Lcom_gwtcx_sample_basic_client_view_ResponseDialogView_1BinderImpl_1GenBundle_1en_1InlineClientBundleGenerator$1_2_classLit);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
;
_.getText = function getText(){
  ...
  returnTemp = ($location_0[stackIndex] = 'ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator.java:' + '23' , $clinit_LocaleInfo() , 'buttonsDiv {\n  float : right;\n  margin-top : 5px;\n}\n');
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
;
_.injected = false;
function $clinit_ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator$styleInitializer(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator$styleInitializer;
  $clinit_ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator$styleInitializer = ($location_0[stackIndex] = 'ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator.java:' + '28' , nullMethod);
  style_0 = new ($location_0[stackIndex] = 'ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator.java:' + '9' , ResponseDialogView_BinderImpl_GenBundle_en_InlineClientBundleGenerator$1_0);
  $stackDepth_0 = stackIndex - 1;
}
...
_.getClass$ = function getClass_274(){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_274;
...
_.getClass$ = function getClass_422(){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_422;
...
_.getClass$ = function getClass_453(){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_453;
...
_.getClass$ = function getClass_461(){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_461;
...
_.getClass$ = function getClass_462(){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_462;
